  ...
  <div class="page">
    ...
    <div class="page-header">
      <div class="header-left">
        ...
        <span class="page-sub">사용자 피드백 현황을 관리해요</span>
      </div>
    </div>
      ...
      <table class="data-table">
        <thead>
          <tr>
            ...
            <th class="col-subcategory">세부 분류</th>
            ...
            <tr v-if="expandedRows.has(index)" class="detail-row">
              <td colspan="5" class="detail-cell">
                <div class="detail-content">
                  <p
                    class="detail-text"
                    :class="{ 'is-empty': !item.content?.trim() }"
                  >
...
import type { Feedback, GetFeedbacksParams } from '@/api/types';
...
const filters = reactive<GetFeedbacksParams>({
  page: 0,
  size: pageSize,
  category: undefined,
  date: undefined,
...
const categoryTabs = [
  ...
  { label: '기능 개선', value: 'IMPROVEMENT' },
  { label: '버그/오류', value: 'BUG' },
  { label: '사용성 불편', value: 'INCONVENIENCE' },
